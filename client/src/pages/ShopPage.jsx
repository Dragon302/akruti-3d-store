    ...
    <div className="min-h-screen bg-[#0f0c29] text-gray-800 p-6 md:p-12">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {products.map((product) => (
          <div key={product._id} className="bg-[#1a163a] rounded-2xl border border-gray-300/10 overflow-hidden hover:border-pink-500/50 transition-all group relative">
            ...
            <div className="h-64 bg-white p-4 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <button onClick={() => addToCart(product)} className="bg-pink-600 text-gray-800 p-3 rounded-full hover:bg-pink-700 transition">
