...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f0c29] text-gray-800 pb-20">
      
      {/* Hero Section */}
      <div className="bg-[#1a163a] py-16 text-center border-b border-gray-300/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 bg-[#1a163a] p-4 rounded-xl border border-gray-300/10">
          ...
          <div className="bg-[#1a163a] p-8 rounded-2xl border border-gray-300/10 shadow-2xl">
            <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
              <MessageCircle className="text-cyan-500" /> Send a message
            </h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <input type="text" value={form.name} onChange={e=>setForm({...form, name: e.target.value})} className="w-full bg-[#0f0c29] border border-gray-300/20 rounded-lg p-3 text-gray-800 outline-none focus:border-pink-500" placeholder="Your Name" required />
              <input type="email" value={form.email} onChange={e=>setForm({...form, email: e.target.value})} className="w-full bg-[#0f0c29] border border-gray-300/20 rounded-lg p-3 text-gray-800 outline-none focus:border-pink-500" placeholder="Your Email" required />
              <textarea rows="4" value={form.message} onChange={e=>setForm({...form, message: e.target.value})} className="w-full bg-[#0f0c29] border border-gray-300/20 rounded-lg p-3 text-gray-800 outline-none focus:border-pink-500" placeholder="How can we help?" required />
